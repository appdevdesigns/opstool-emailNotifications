...
.then(function(){
    ...
    describe('testing controller AD.controllers.opstools.EmailNotifications.Portal ', function(){
        ...
        before(function(){
            ...
            testController = new AD.controllers.opstools.EmailNotifications.Portal($('#'+divID), { some:'data' });
        ...
        it('controller definition exists ', function(){
            ...
            assert.isDefined(AD.controllers.opstools.EmailNotifications.Portal, ' :=> should have been defined ');
